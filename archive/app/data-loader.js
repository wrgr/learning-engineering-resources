...
function normalizePaper(paper) {
  return {
    ...
    source_expansion: cleanText(paper.source_expansion || ""),
    registry_program_id: cleanText(paper.registry_program_id || ""),
    registry_person_id: cleanText(paper.registry_person_id || ""),
    thematic_query_id: cleanText(paper.thematic_query_id || ""),
  };
}
